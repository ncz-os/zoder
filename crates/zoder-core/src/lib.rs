...
pub use acp_client::{
    cancel_session, new_session, probe_ready, run_agent, run_agent_dispatch, run_goose_agent,
    wait_for_socket, write_tool_matrix, write_tool_matrix_human, AgentEvent, AgentOptions,
    AgentRun, ApprovalPolicy, DaemonReadiness, EngineKind, GooseProviderEnv, WriteToolMatrixRow,
